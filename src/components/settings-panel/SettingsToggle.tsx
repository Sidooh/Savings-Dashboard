...
const SettingsToggle = () => {
    ...
    const handleClick = () => dispatch(setTheme({key: 'showSettingPanel', value: true}));

    return (
        <Card className="cursor-pointer setting-toggle" onClick={handleClick}>
            <Card.Body className="d-flex align-items-center py-md-2 px-2 py-1">
                <div className="bg-soft-primary position-relative rounded-start"
